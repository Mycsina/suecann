...
\node[widebox, belief, minimum height=14mm] (belief) {
  \textbf{Belief State}\\[1pt]
  \footnotesize 35 public-info features $\in [0,1]$
};

% === Stage 2: WANN ===
\node[widebox, wann, right=of belief, minimum height=14mm] (wann) {
  \textbf{WANN}\\[1pt]
...
% === Stage 3: Intents ===
\node[narrowbox, intent, right=of wann, minimum height=14mm] (intents) {
  \textbf{3 Intents}\\[1pt]
...
\node[label, below=8mm of wann.south, align=center] {
...
% === Braces for phases ===
% Use the tallest box (intents) as the baseline so the brace is horizontal
\draw [decorate, decoration={brace, amplitude=4pt}, black!40, thick]
  ($(belief.north west |- intents.north) + (-2pt, 4pt)$) -- ($(intents.north east) + (0pt, 4pt)$)
  node[midway, above=5pt, font=\footnotesize\sffamily, black!50] {Neurosymbolic core (evolved)};

\draw [decorate, decoration={brace, amplitude=4pt}, black!40, thick]
  ($(resolver.north west |- card.north) + (0pt, 4pt)$) -- ($(card.north east) + (2pt, 4pt)$)
