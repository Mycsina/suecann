...
def test_cut_low_legality_when_trump_led():
    ...
    h0 = [Card(Suit.HEARTS, Rank.TWO), Card(Suit.HEARTS, Rank.THREE)] + [Card(Suit.SPADES, r) for r in list(Rank)[:8]]
    h1 = [Card(Suit.DIAMONDS, r) for r in list(Rank)[:10]]
    h2 = [Card(Suit.CLUBS, r) for r in list(Rank)[:10]]
    h3 = [Card(Suit.HEARTS, Rank.ACE), Card(Suit.HEARTS, Rank.KING)] + [Card(Suit.SPADES, r) for r in list(Rank)[2:]]
...
def test_cut_low_illegal_when_non_trump_led_and_holding_led_suit():
    ...
    h0 = [Card(Suit.HEARTS, Rank.TWO), Card(Suit.SPADES, Rank.THREE)] + [Card(Suit.DIAMONDS, r) for r in list(Rank)[:8]]
    h1 = [Card(Suit.DIAMONDS, r) for r in list(Rank)[:10]]
    h2 = [Card(Suit.CLUBS, r) for r in list(Rank)[:10]]
    h3 = [Card(Suit.SPADES, Rank.ACE), Card(Suit.HEARTS, Rank.KING)] + [Card(Suit.SPADES, r) for r in list(Rank)[2:]]
...
def test_cut_low_legal_when_non_trump_led_and_void_in_led_suit():
    ...
    h0 = [Card(Suit.HEARTS, Rank.TWO), Card(Suit.HEARTS, Rank.THREE)] + [Card(Suit.DIAMONDS, r) for r in list(Rank)[:8]]
    h1 = [Card(Suit.DIAMONDS, r) for r in list(Rank)[:10]]
    h2 = [Card(Suit.CLUBS, r) for r in list(Rank)[:10]]
    h3 = [Card(Suit.SPADES, Rank.ACE), Card(Suit.HEARTS, Rank.KING)] + [Card(Suit.SPADES, r) for r in list(Rank)[2:]]
