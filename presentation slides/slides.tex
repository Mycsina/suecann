  ...
  \begin{columns}[T]
    \column{0.50\textwidth}
      ...
      \begin{tikzpicture}[scale=0.80]
        ...
        \draw[<-,thick,blue!60] (S0) -- (S2) node[midway,left,blue] {team};
        \draw[<-,thick,red!60] (S1) -- (S3) node[midway,above,red] {team};
        % Turn order
...
\begin{frame}{You can explore the champion's decision-making interactively in the browser}
  ...
  \begin{center}
    ...
    \scriptsize\url{https://github.com/andre-csilva/sueca-wann}
  \end{center}
\end{frame}
...
\begin{frame}{Richer intents and opponent-card inference are the path to breaking the 58\% ceiling}
  ...
  {\footnotesize\url{https://github.com/andre-csilva/sueca-wann}}
\end{frame}
